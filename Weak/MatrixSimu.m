...
TestCase = 0; %choose which test we want to do: 
% 0-> block tests
% 1-> LASSO SDA
...
for c = 1:nChunks
    ...
    parfor idx = 1:nk
        ...
        W1all = Feature(M, D1,   Tk, r, signalT, "two-diff","single");
        W2all = Feature(M, D2,   Tk, r, signalT, "two-diff","single");
        W3all = Feature(M, Dall, Tk, r, signalT, "two-diff","double");
